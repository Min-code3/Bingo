...
export const MAIN_CELLS: CellConfig[] = [
  { id: 'wild',   label: 'Wild',     sub: '자유사진',   icon: '🌸', grad: 'linear-gradient(135deg,#FFB7C5,#FF85A2)', pp: '0% 0%',   ps: '300% 300%', image: '/images/cells/wild.png',   description: '자유롭게 오사카의 아무 장소에서 사진을 찍어보세요!', mapQuery: 'Osaka,Japan' },
...
export const KYOTO_FOOD_CELLS: CellConfig[] = [
  { id: 'f-wild',       label: 'Wild',         sub: '자유 음식',   icon: '🍽️', grad: 'linear-gradient(135deg,#ffd200,#f7971e)', pp: '', ps: '' },
  { id: 'f-takoyaki',   label: '타코야키',      sub: '',           icon: '🐙', grad: 'linear-gradient(135deg,#c04848,#6a1b1b)', pp: '', ps: '' },
  { id: 'f-ramen',      label: '라멘',          sub: '',           icon: '🍜', grad: 'linear-gradient(135deg,#f7e98e,#b8860b)', pp: '', ps: '' },
  { id: 'f-mochi',      label: '딸기모찌',      sub: '',           icon: '🍓', grad: 'linear-gradient(135deg,#ff9a9e,#fad0c4)', pp: '', ps: '' },
  { id: 'f-cake',       label: '케이크',        sub: '',           icon: '🍰', grad: 'linear-gradient(135deg,#f5e6ca,#d4a56a)', pp: '', ps: '' },
  { id: 'f-okonomiyaki',label: '오코노미야끼',   sub: '',           icon: '🥘', grad: 'linear-gradient(135deg,#8B6914,#654321)', pp: '', ps: '' },
  { id: 'f-gyukatsu',   label: '규카츠',        sub: '',           icon: '🥩', grad: 'linear-gradient(135deg,#8e2024,#4a0e10)', pp: '', ps: '' },
  { id: 'f-yakitori',   label: '야끼토리',      sub: '',           icon: '🍢', grad: 'linear-gradient(135deg,#f7971e,#a84300)', pp: '', ps: '' },
  { id: 'f-sushi',      label: '스시',          sub: '',           icon: '🍣', grad: 'linear-gradient(135deg,#ff6b6b,#ee5a24)', pp: '', ps: '' },
];
